...
<p className="mt-6   hero_desc max-w-[530px] ">
  ...
  <section className="max-w-[1189px] mx-auto px-4 sm:px-6 lg:px-8 mt-20 relative">
   <div className="border border-blue-400 rounded-lg p-6 max-w-4xl mx-auto text-center">
    <h2 className="text-blue-500 font-bold text-lg uppercase tracking-widest">
     OUR PRODUCT
    </h2>
    <p className="text-gray-700 mt-2 font-semibold text-xl">
     premium coffee to available
    </p>
    <p className="text-gray-500 mt-1 text-sm">
     Discover our exclusive range of coffee blends crafted for every taste.
    </p>
   </div>
   <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
    <div className="bg-white rounded-lg shadow-md p-4 text-left text-black">
     <img alt="Americano coffee cup on white background with coffee beans" className="rounded-md w-full h-40 object-cover" height="200" src="https://storage.googleapis.com/a1aa/image/506fb135-3d17-44ff-ddcb-f19f8016fd8c.jpg" width="320"/>
    ...
    <div className="bg-white rounded-lg shadow-md p-4 text-left text-black">
     <img alt="Cappuccino coffee cup with frothy milk and latte art" className="rounded-md w-full h-40 object-cover" height="200" src="https://storage.googleapis.com/a1aa/image/0af2baba-150d-4d5a-2d06-4658e4993a47.jpg" width="320"/>
     <h3 className="font-semibold mt-3 text-lg">
      Cappuccino
     </h3>
     <p className="text-sm mt-1 text-gray-700">
      Espresso with steamed milk foam, rich and creamy.
     </p>
    </div>
    <div className="bg-white rounded-lg shadow-md p-4 text-left text-black">
     <img alt="Stack of cookies on white plate with coffee cup" className="rounded-md w-full h-40 object-cover" height="200" src="https://storage.googleapis.com/a1aa/image/09adab06-1c9b-4d19-ba0f-7e34af18f6e0.jpg" width="320"/>
     <h3 className="font-semibold mt-3 text-lg">
      Cookies
     </h3>
     <p className="text-sm mt-1 text-gray-700">
